...
RUTA_TXT_BASES="data/inputs/Informe Bases Cotizacion Online.txt"  # Ruta del txt original descargado de la Seguridad Social (sin formato tabular)
RUTA_PDF_BASES="data/inputs/Informe Bases Cotizaci*n Online.pdf"  # Ruta del PDF original descargado de la Seguridad Social (sin formato tabular)
